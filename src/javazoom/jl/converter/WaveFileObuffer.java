...
public class WaveFileObuffer extends Obuffer
{
   ...
   */
  public WaveFileObuffer(int number_of_channels, int freq, int bitsPerSample, String FileName)
  {
  	if (FileName==null)
	...
	int rc = outWave.OpenForWrite (FileName, freq, (short)bitsPerSample, (short)channels);//@TODO:remove hard coding
  }
...
//		e.printStackTrace();
//		System.out.println("\n\nchannel " + String.valueOf(channel) +" value " + 
//				  String.valueOf(value) + " bufferp " + String.valueOf(bufferp[channel]));
	}
  }
  ...
  public int write_buffer(int val)
  {
	  
    int bufSiz = bufferp[0];
    int rc = 0;
    
    bufSiz = outWave.WriteData(buffer, bufferp[0]);
